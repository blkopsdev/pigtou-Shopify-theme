...
var vartop = 1;
$(document).ready(function(){var contentButton = [];var contentTop = [];var content = [];var lastScrollTop = 0;var scrollDir = '';var itemClass = '';var itemHover = '';var menuSize = null;var stickyHeight = 0;var stickyMarginB = 0;var currentMarginT = 0;var topMargin = 0;$(window).scroll(function(event){var st = $(this).scrollTop();if (st > lastScrollTop){scrollDir = 'down';} else {scrollDir = 'up';}lastScrollTop = st;});$.fn.stickUp = function( options ) {$(this).addClass('stuckMenu');var objn = 0;if(options != null) {for(var o in options.parts) {if (options.parts.hasOwnProperty(o)){content[objn] = options.parts[objn];objn++;}}if(objn == 0) {console.log('error:needs arguments');}itemClass = options.itemClass;itemHover = options.itemHover;if(options.topMargin != null) {if(options.topMargin == 'auto') {topMargin = parseInt($('.stuckMenu').css('margin-top'));} else {if(isNaN(options.topMargin) && options.topMargin.search("px") > 0){topMargin = parseInt(options.topMargin.replace("px",""));} else if(!isNaN(parseInt(options.topMargin))) {topMargin = parseInt(options.topMargin);} else {console.log("incorrect argument, ignored.");topMargin = 0;}	}} else {topMargin = 0;}menuSize = $('.'+itemClass).size();}stickyHeight = parseInt($(this).height());stickyMarginB = parseInt($(this).css('margin-bottom'));currentMarginT = parseInt($(this).next().closest('div').css('margin-top'));vartop = ($(this).offset().top)?parseInt($(this).offset().top):1;};$(document).on('scroll', function() {varscroll = parseInt($(document).scrollTop());if(menuSize != null){for(var i=0;i < menuSize;i++){contentTop[i] = $('#'+content[i]+'').offset().top;function bottomView(i) {contentView = $('#'+content[i]+'').height()*.4;testView = contentTop[i] - contentView;if(varscroll > testView){$('.'+itemClass).removeClass(itemHover);$('.'+itemClass+':eq('+i+')').addClass(itemHover);} else if(varscroll < 50){$('.'+itemClass).removeClass(itemHover);$('.'+itemClass+':eq(0)').addClass(itemHover);}}if(scrollDir == 'down' && varscroll > contentTop[i]-50 && varscroll < contentTop[i]+50) {$('.'+itemClass).removeClass(itemHover);$('.'+itemClass+':eq('+i+')').addClass(itemHover);}if(scrollDir == 'up') {bottomView(i);}}}if(vartop < varscroll + topMargin){$('.stuckMenu').addClass('isStuck');$('.stuckMenu').next().closest('div').css({'margin-top': stickyHeight + stickyMarginB + currentMarginT + 'px'}, 10);$('.stuckMenu').css("position","fixed");$('.isStuck').css({top: '0px'}, 10, function(){});};if(varscroll + topMargin < vartop){$('.stuckMenu').removeClass('isStuck');$('.stuckMenu').next().closest('div').css({'margin-top': currentMarginT + 'px'}, 10);$('.stuckMenu').css("position","relative");};});});
...
theme.Parallax = (function() {
  function Parallax(container) {
    ...
    // Parallax scrolling backgrounds  edit to work with new theme editor
    var initParallaximage = function(ParallaxImages) {
      $('.parallax-window').parallax();
    };

    initParallaximage($('.parallax-window'));
 ...
 */
  ...
  /**
 * ----------------------------------------------------------------------------------------------------
 * Allow usage of Owl Carousel anywhere...
 * ----------------------------------------------------------------------------------------------------
 */
  ...
  /**
 * ----------------------------------------------------------------------------------------------------
 * Use Fancybox for any class of ....fancybox
 * ----------------------------------------------------------------------------------------------------
 */
  ...
  /**
 * ----------------------------------------------------------------------------------------------------
 * Sticky navigation for all but mobile
 * ----------------------------------------------------------------------------------------------------
 */
...
var product = {
  init: function(){
    ...
    selectCallback = function(variant, selector) {
			console.log('#product-' + selector.product.id);

      var $product = $('#product-' + selector.product.id),
          $productForm = $('#AddToCartForm', $product);
      if (variant && variant.featured_image) {
        var original_image = $('.mainimage'), new_image = variant.featured_image;
      ...
      if (variant && variant.available == true) {
				console.log('here1');
				console.log(variant);
				console.log('1>>>' + variant.compare_at_price);
				console.log('2>>>' + variant.price);

        if(variant.compare_at_price > variant.price){
					console.log('here3');
          $('.was', $product).html(Shopify.formatMoney(variant.compare_at_price, $productForm.data('money-format')))
        } else {
					console.log('here4');
          $('.was', $product).text('')
        }     
        $('.product-price').removeClass('sold');
				console.log($product);
        //$('.product-price', $product).html(Shopify.formatMoney(variant.price, $productForm.data('money-format')));

				$('.product-price').html('<span class="money">'+Shopify.formatMoney(variant.price, $productForm.data('money-format'))+'</span>');
        $("#AddToCart").html('Add to Cart for <span class="money">'+Shopify.formatMoney(variant.price, $productForm.data('money-format'))+'</span>');

        $('.add', $product).removeClass('disabled').removeAttr('disabled').val("Add to Cart");
      } else { 
				console.log('here2');
        $('.product-price').addClass('sold');
        ...
        $('.add', $product).addClass('disabled').attr('disabled', 'disabled').val(message);
			...
			if ($('#AddToCartForm ').hasClass('with_variants')) {
			var prodId = $('.product-page').data("product-id"),
					productSingleObject = JSON.parse(document.getElementById('ProductJson-' + prodId).innerHTML);

			$('#AddToCartForm').each(function() {
			new Shopify.OptionSelectors('product-select-' + prodId, { product: productSingleObject, onVariantSelected:
			selectCallback, enableHistoryState: false });
    }); 

    $(document).on('shopify:section:unload', '.product-page', function(event){
      delete Shopify.OptionSelectors();
    });
  }

    
    $("#shopify-section-product-template").addClass("product-page");
setInterval(function(){ 
  if($('.viddo-1').parent().hasClass('active')){
      var youtube_img = $('.viddo-1').find('img').attr('alt');
     if( $('.viddo-1').find('.video_wrapper').length < 1 ){
   	     $('.viddo-1').find('img').hide();
       	$('.viddo-1').append('<div class="video_wrapper" style="height:auto; padding-bottom: 0;" ><video  class="video--wrap"  muted playsinline autoplay  loop  id="viddd" muted  onload="playVid(); "><source src=" '+youtube_img+'" type="video/mp4"> </div>');
        
       	$('.viddo-1 .video--wrap').on('loadstart', function (event) {
          $(this).addClass('loading');
            $(this).css('width' , $(this).parent('#bigimage').find('.mainimage').width());
      		$(this).css('height' , $(this).parent('#bigimage').find('.mainimage').height());
        });
        $('.viddo-1 .video--wrap').on('canplay', function (event) {
   ...
   $('.viddo-1 img').show().css('opacity','0');
  }
}, 500);

//   $('#bigimage').zoom();

  var image = $('#bigimage  img');
  var zoomConfig = {};
...
image.on('click', function(e){
  if($("div#zoomDivPro").children().length >0){
   ...
   close_accordion_section();
    ...
    $(this).elevateZoom({zoomType: "inner",cursor: "crosshair",divId: "zoomDivPro"});//initialise zoom
...
//   }
    ...
    $('.datttt').click(function(){
      
   var dfr = $(this).data('idd');
      $('.thumbnails').find('a#'+dfr).trigger('click');
      
      
    });

//  $('.mthumb').click(function(e) {
//   e.preventDefault(); 
//    var youtube_img = $(this).find('img').attr('alt');
//    if(youtube_img.indexOf('youtube') > 0){
//           $(this).find('.video_wrapper').remove();
//   	$(this).append('<div class="video_wrapper"><iframe id="video4743" ></iframe></div>');
//       $(this).find('img').hide();
//    $("#video4743").attr('src',  youtube_img+"?HD=1;autoplay=1&rel=0&showinfo=0;controls=0;");      
//      setTimeout(function(){  $('#video4743').contents().find('.ytp-large-play-button').trigger('click'); }, 3000);
//    }else{   
//     $(this).find('.video_wrapper').remove();
//     $(this).find('img').show();
//    }
...
$('.clicker-thumb').click(function(e) {
 ...
 $('#zoomDivPro').empty();
  ...
  var youtube_img = $(this).find('img').attr('alt');
  console.log(youtube_img);
  if(youtube_img.indexOf('mp4') > 0){
//     $('.image-dot').show();
 $('#zoomDivPro').empty();
//     $('.main-image-navigation').css('display','none');
    $('.video--wrap').css('cursor','auto');
    $('#bigimage .video_wrapper').remove();
    $('#bigimage').find('img').css('opacity', '0');
    if( $('#bigimage').find('video').length < 1 ){
         var width = $(window).width();
  
   
 
      $('.image-dottt').prepend('<div id="video_wrapper" ><video  class="video--wrap"  muted playsinline autoplay  loop style="width: 100%; height: 100%;"><source src=" '+youtube_img+'" type="video/mp4"> </div>');

      
      $('.image-dottt .video--wrap').on('loadstart', function (event) {
        $(this).addClass('loading');
        $(this).css('width' , $(this).parents('#bigimage img').width());
      	$(this).css('height' , $(this).parents('#bigimage img').height());
      });
      $('.image-dottt .video--wrap').on('canplay', function (event) {
        $(this).removeClass('loading')
      });
  }
     $('#bigimage img').attr('src',newImage);
    
   $('#bigimage').css('cursor','auto');
  }else{
    
    $('.image-dot').hide();
//     $('.main-image-navigation').css('display','block');
     $('#bigimage').css('cursor','zoom-in');
    $('#video_wrapper').remove();
     $('#bigimage').find('img').css('opacity', '1');
     $('#bigimage img').show().attr('src',newImage);
    // close_accordion_section();
     //  $('#bigimage img').addClass('active');
  // $('#bigimage img').elevateZoom({zoomType: "inner",cursor: "crosshair",divId: "zoomDivPro"});//initialise zoom
...
$(document).on('shopify:section:unload', function(event) {
  var target = $(event.target);
  target.find('#bigimage').zoom('destroy');
  $(document).off('#bigimage');
});
...
document.addEventListener("StartAppInitLoading", function(event) {
  ...
  sections.register('questionnaire-section', theme.questionnaire.init)
...
$(this).css('pointer-events', 'none');
    setTimeout(function(){
      $('#AddToCart').css('pointer-events', 'all');
      $('.site-header__cart-toggle.js-drawer-open-right')[0].click();
    },700);
...
// {
//     var container = $("#shopify-section-mobile-navigation");
...
// var ios_devices = user_agent.match(/(iphone|ipod|ipad)/)  ? "touchstart" : "mouseup"; //check ios devices

// console.log('useragentt');
// console.log(ios_devices);
// if( ios_devices ){
// $(document).bind(ios_devices , function() { // bind the ios devices 
//   var container = $("#shopify-section-mobile-navigation");
...
// }
 ...
 $(document).ready(function ()
   ...
   $(".related-products").find('.title').each(function(i){
  ...
  $(".row.homepage-section").show();
   $(".shopify-section .index-section.hide_section .brnds").hide();
  });
 
  
   
//   console.log('jh');
//    $('body').on('click', '.skinbtn', function(){
// //   $('.skinbtn').click(function(){
//    var att= $(this).attr('data-colink');
//    console.log('jh');
// $.ajax({
//     type: "GET",
//     url: att,
...
//         console.log('htttttttttttttt');
      
      
//       $(".shopify-section .index-section.hide_section").prepend('<div class="brnds" >'+result+'</div>');
   // $(".hide_section #page").append('<a class="back_page" href="javascript:void(0)">« back</a>');
      
      
      
//        $('.hide_section div#shopify-section-footer').css('display','none');   
//       $('.hide_section div#shopify-section-header').css('display','none');       

//     }
// });
    
// //     alert('hello');
//     $(".row.homepage-section").hide();
...
// $.get("https://pigtou.com/collections/"+xvf+"?view=vendors", function(data, status){
// console.log(data);   
//   $('.hide_section').html(data);
// });
//   });
 });

console.log('__opt-dev-theme-16');
